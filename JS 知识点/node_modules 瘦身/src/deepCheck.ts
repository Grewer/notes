...
async function main(spinner) {
    ...
    fs.writeFileSync(`deepCheck.json`, `${JSON.stringify(mapChangeObj(packs), null, 2)}`, {encoding: 'utf-8'})

    // 打印 top5
    console.log(chalk.yellow('占用空间最大的 5 个库:'))
